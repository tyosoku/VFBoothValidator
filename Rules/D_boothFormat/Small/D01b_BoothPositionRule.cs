...
namespace VketTools
{
    ...
    /// これをＶＦ２小ホール仕様へ
    /// </summary>
    public class BoothPositionRule_C : BaseRule
    {
        //ルール名
        public new string ruleName = "Ð01b_C.ブース内包 Rule";
        ...
        public BoothPositionRule_C(Options _options) : base(_options)
        {
        }
        ...
        public override Result Validate()
        {
            //初期化
            base.Validate();
            Bounds outBounds = new Bounds(new Vector3(0, 1.25f, -1.0f), new Vector3(2.0001f, 2.5001f, 2.0001f));
