...
namespace VketTools
{
    ...
    /// さらにここからVF2小ホール仕様へ
    /// </summary>
    public class BoothSizeRule_C : BaseRule
    {
        //ルール名
        public new string ruleName = "Ð01_C.ブースサイズ Rule";
        ...
        public BoothSizeRule_C(Options _options) : base(_options)
        {
        }
        ...
        public override Result Validate()
        {
            //初期化
            base.Validate();
            Vector3 maxBoundsSize = new Vector3(2, 3, 2);　//サイズ指定
            //検証ロジック
