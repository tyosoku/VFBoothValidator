...
namespace VketTools
{
    ...
    /// VF2大ホールは続投
    /// </summary>
    public class BoothPivotRule_C : BaseRule
    {
        //ルール名
        public new string ruleName = "Ð01a_C.ブースピボット Rule";
        ...
        public BoothPivotRule_C(Options _options) : base(_options)
        {
        }
        ...
        public override Result Validate()
        {
            //初期化
            base.Validate();
            Bounds outBounds = new Bounds(new Vector3(0, 1.25f, -0.5f), new Vector3(2.0f, 2.5f, 2.0f));
