...
namespace VketTools
{
    ...
    /// さらにここからVF2大ホール仕様へ
    /// </summary>
    public class BoothSizeRule_A : BaseRule
    {
        //ルール名
        public new string ruleName = "Ð01_A.ブースサイズ Rule";
        ...
        public BoothSizeRule_A(Options _options) : base(_options)
        {
        }
        ...
        public override Result Validate()
        {
            //初期化
            base.Validate();
            Vector3 maxBoundsSize = new Vector3(5, 5, 5);　//サイズ指定
            //検証ロジック
