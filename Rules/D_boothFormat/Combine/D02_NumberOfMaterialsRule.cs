...
namespace VketTools
{
    ...
    /// これをVF2合同用へ
    /// </summary>
    public class NumberOfMaterialsRule_B : BaseRule
    {
        //ルール名
        public new string ruleName = "Ð02_B.マテリアル数制限 rule";
        ...
        public NumberOfMaterialsRule_B(Options _options) : base(_options)
        {
        }
