...
namespace VketTools
{
    ...
    /// さらにここからVF2合同仕様へ
    /// </summary>
    public class BoothSizeRule_B : BaseRule
    {
        //ルール名
        public new string ruleName = "Ð01_B.ブースサイズ Rule";
        ...
        public BoothSizeRule_B(Options _options) : base(_options)
        {
        }
        ...
        public override Result Validate()
        {
            //初期化
            base.Validate();
            Vector3 maxBoundsSize = new Vector3(10, 5, 5);　//サイズ指定
            //検証ロジック
