...
namespace VketTools
{
    ...
    /// これをVF2合同用へ
    /// </summary>
    public class BoothPositionRule_B : BaseRule
    {
        //ルール名
        public new string ruleName = "Ð01b_B.ブース内包 Rule";
        ...
        public BoothPositionRule_B(Options _options) : base(_options)
        {
        }
        ...
        public override Result Validate()
        {
            //初期化
            base.Validate();
            Bounds outBounds = new Bounds(new Vector3(0, 2.5f, -2.5f), new Vector3(10.0001f, 5.0001f, 5.0001f));
