...
namespace VketTools
{
    ...
    /// VF2合同用
    /// </summary>
    public class BoothPivotRule_B : BaseRule
    {
        //ルール名
        public new string ruleName = "Ð01a_a.ブースピボット Rule";
        ...
        public BoothPivotRule_B(Options _options) : base(_options)
        {
        }
        ...
        public override Result Validate()
        {
            //初期化
            base.Validate();
            Bounds outBounds = new Bounds(new Vector3(0, 2.5f, -2.5f), new Vector3(10.0f, 5.0f, 5.0f));
